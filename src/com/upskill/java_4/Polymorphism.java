	...
	//Same method name from Parent class to override in the Child class and need to create an object inside the main class..
	...
	//Same method name with different signature/code to be executed and need to create an object inside the main class.
